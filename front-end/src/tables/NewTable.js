...
export default function NewTable({ loadDashboard }) {
  ...
  const [error, setError] = useState(null); // Changed from [] to null for default error state
  ...
  return (
    <div>
      ...
      <div className="d-flex justify-content-center mt-4">
        <form className="font-weight-bold mt-2 w-75" onSubmit={handleSubmit}>
          <ErrorAlert error={error} />{" "}
          {/* Uncommented ErrorAlert for error display */}
